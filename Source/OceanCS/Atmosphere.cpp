...
void Atmosphere::init(float BetaRayMultiplier, float BetaMieMultiplier, float InscatteringMultiplier, float ExtinctionMultiplier, float HGg)
{
	m_fInscatteringMultiplier = InscatteringMultiplier;
	m_fExtinctionMultiplier = ExtinctionMultiplier;
	m_fHGg = HGg;

	m_fBetaRayMultiplier = BetaRayMultiplier;
	m_fBetaMieMultiplier = BetaMieMultiplier;
